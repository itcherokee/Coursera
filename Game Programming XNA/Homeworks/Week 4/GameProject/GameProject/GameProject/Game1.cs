...
namespace GameProject
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        private void SpawnBear()
        {
            ...
            int locationX = GetRandomLocation(GameConstants.SPAWN_BORDER_SIZE, GameConstants.WINDOW_WIDTH - GameConstants.SPAWN_BORDER_SIZE * 2);
            int locationY = GetRandomLocation(GameConstants.SPAWN_BORDER_SIZE, GameConstants.WINDOW_HEIGHT - GameConstants.SPAWN_BORDER_SIZE * 2);

            // generate random velocity
            float speed = GameConstants.MIN_BEAR_SPEED +
                    RandomNumberGenerator.NextFloat(GameConstants.BEAR_SPEED_RANGE - GameConstants.MIN_BEAR_SPEED);
            float angle = 2 * (float)Math.PI * RandomNumberGenerator.NextFloat(1);
            ...
            // create new bear
            TeddyBear newBear = new TeddyBear(Content, "teddybear", locationX, locationY, bearVelocity, null, null);
